...
extern const string pointCloudTopic = "/assemble_yrl";
...
//Yujin LiDAR V2
extern const int N_SCAN = 24;
extern const int Horizon_SCAN = 1440;
extern const float ang_res_x = 0.25;
extern const float ang_res_y = 40/float(N_SCAN-1);
extern const float ang_bottom = 5;
extern const int groundScanInd = 7;
...
extern const int sectionsTotal = 10;
extern const float edgeThreshold = 0.16;

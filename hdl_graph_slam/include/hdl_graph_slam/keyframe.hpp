...
public:
  ...
  // KeyFrame(const ros::Time& stamp, const Eigen::Isometry3d& odom, double accum_distance, const pcl::PointCloud<PointRGBT>::ConstPtr& cloudRGB);

  KeyFrame(const ros::Time& stamp, const Eigen::Isometry3d& odom, double accum_distance, const pcl::PointCloud<PointT>::ConstPtr& cloud,const pcl::PointCloud<PointRGBT>::ConstPtr cloudRGB=nullptr);
...
public:
  ...
  pcl::PointCloud<PointRGBT>::ConstPtr cloudRGB;
...
public:
  ...
  KeyFrameSnapshot(const Eigen::Isometry3d& pose, const pcl::PointCloud<PointT>::ConstPtr& cloud, pcl::PointCloud<PointRGBT>::ConstPtr cloudRGB=nullptr);

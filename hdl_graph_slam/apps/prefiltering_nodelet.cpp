...
private:
  void initialize_params() {
    ...
    std::cout << "use_distance_filter: " << std::boolalpha << use_distance_filter << std::endl;
    std::cout << "distance_near_thresh: " << distance_near_thresh << std::endl;
    std::cout << "distance_far_thresh: " << distance_far_thresh << std::endl;
